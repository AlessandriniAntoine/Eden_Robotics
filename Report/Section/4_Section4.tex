...
\bigbreak
The figure below shows the kinematics schema of the robot. The figure defines an \{s\} \Gls{frame} at the bottom, an \{e\} frame at the end effector position, and a \{c\} frame at the camera position. The robot is at its home configuration. The joints are represented with the rotation (positive rotation about the axes is by the right-hand rule).
...
\bigbreak
We can then define $M_c$ and the $M_e$ transformation matrix ($T_{sc}$ and $T_{se}$) when the robot is at its home configuration. 
...
\begin{figure}[H]
    \begin{subfigure}{.5\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{Images/Section04/workspace\_xy\_plan.png}
        \caption{XY plan for z=0.07m}
        \label{fig:WorkspaceXY}
    \end{subfigure}%
    \begin{subfigure}{.5\linewidth}
        \centering
        \includegraphics[width=1\textwidth]{Images/Section04/workspace\_xz\_plan.png}
        \caption{XZ plan for y=0m}
        \label{fig:WorkspaceXZ}
    \end{subfigure}\\[1ex]
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=0.5\textwidth]{Images/Section04/workspace\_yz\_plan.png}
