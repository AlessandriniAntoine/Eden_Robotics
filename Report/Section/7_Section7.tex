...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{images/Section07/launch\_rviz.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{images/Section07/launch\_inversekinematics.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{images/Section07/launch\_openloop.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{images/Section07/launch\_closedloop.png}
